 ...
 * @author BTCI
 */
public class CacheFactoryBean implements FactoryBean<CacheHandler>, InitializingBean {

    /** The Constant logger. */
    private static final Logger LOGGER = Logger.getLogger(CacheFactoryBean.class);
