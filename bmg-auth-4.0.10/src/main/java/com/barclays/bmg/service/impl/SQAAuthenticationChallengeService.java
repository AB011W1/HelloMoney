...
/**
 * SQA Authentication Challenge Service
 * 
 * @author e20026338
 * 
 */
public class SQAAuthenticationChallengeService implements AuthenticationChallengeService {
     ...
     * @return
     */
    @AuditSupport(auditType = AuditConstant.AUDIT_TYPE_TRANSACTION, activityState = AuditConstant.SRC_COM_SSC, serviceDescription = "CHALLENGE_SQA_DESC", stepId = "2", activityType = "auth")
