 ...
 * <b>SecondAuthenticationJSONBldr.java</b> </br> Description is <b>Initial Version</b> </br> Updated Date is <b>May 21, 2013</b> </br>
 * ***********************************************************
 *
 * @author E20043104
 *
 */
public class SecondAuthenticationJSONBldr implements BMBJSONBuilder {
	...
	if (responseContext instanceof SecondAuthenticationOperationResponse) {
	    SecondAuthenticationOperationResponse response = (SecondAuthenticationOperationResponse) responseContext;
     ...
     *
     * @param SecondAuthenticationOperationResponse
     * @return BMBPayloadHeader
     */
    protected BMBPayloadHeader createHeader(SecondAuthenticationOperationResponse response) {
     ...
     * @return void
     */
    protected void populatePayLoad(SecondAuthenticationOperationResponse response, BMBPayload bmbPayload) {
	SecondAuthenticationJSONResponseModel responseModel = null;
	if (response != null) {

	    responseModel = new SecondAuthenticationJSONResponseModel();
	...
	String respId = ResponseIdConstants.SECOND_AUTH_INIT_RESPONSE_ID;
