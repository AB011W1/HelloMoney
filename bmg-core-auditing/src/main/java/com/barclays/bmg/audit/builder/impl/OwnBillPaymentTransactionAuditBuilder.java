...
public class OwnBillPaymentTransactionAuditBuilder extends AbstractTransactionAuditBuilder {
    private final static String SCRNAME_BP = "PMT_FT_CARD_PAYMENT_OWN";
	...
	Double txnAmount = transactionDTO.getTxnAmt().getAmount().doubleValue();
	String currency = transactionDTO.getSourceAcct().getCurrency();
	...
	transactionAuditDTO.setCreditCardNo(cardNumber);
	...
	if (request != null) {
	    ...
	    field7.setValue(MaskingUtil.getMaskedCreditCardNumber((request.getTransactionDTO().getBeneficiaryDTO().getCardNumber())));
