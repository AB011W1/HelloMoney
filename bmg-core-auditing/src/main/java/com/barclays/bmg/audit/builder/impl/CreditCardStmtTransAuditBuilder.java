...
public class CreditCardStmtTransAuditBuilder extends AbstractTransactionAuditBuilder {

    /**
     * The Constant named "SCRNNAM_BP" is created.
     */
    private static final String SCRNNAM_BP = "VIEW_CREDIT_CARD_STMT_TRANS";

    @Override
    public TransactionAuditDTO buildFromRequest(Object[] args, Object result) {

	CreditCardStmtTransOperationRequest request = (CreditCardStmtTransOperationRequest) args[0];
	...
	field8.setValue(AuditConstant.SER_TYP_CCD_STATEMENT);
	screenData.addField(field8);

	FieldDataDTO field9 = new FieldDataDTO();
	field9.setFieldId(AuditConstant.TXNSUBTYP);
	field9.setValue(AuditConstant.SUB_SER_TYP_CCD_STATEMENT);
	...
	CreditCardStmtTransOperationResponse response = (CreditCardStmtTransOperationResponse) result;
	ScreenDataDTO screenData = new ScreenDataDTO();
