...
public class InterestRateAuditBuilder extends AbstractTransactionAuditBuilder {

    /**
     * The Constant named "SCRNNAM_BP" is created.
     */
    private static final String SCRNNAM_BP = "VIEW_FD_RATES";

    @Override
    public TransactionAuditDTO buildFromRequest(Object[] args, Object result) {

	InterestRatesOperationRequest request = (InterestRatesOperationRequest) args[0];
	...
	InterestRatesOperationResponse response = (InterestRatesOperationResponse) result;
	ScreenDataDTO screenData = new ScreenDataDTO();
