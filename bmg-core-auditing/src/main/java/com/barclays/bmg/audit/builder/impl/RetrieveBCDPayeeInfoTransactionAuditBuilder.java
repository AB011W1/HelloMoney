...
public class RetrieveBCDPayeeInfoTransactionAuditBuilder extends AbstractTransactionAuditBuilder {
    @Override
	...
	MergeBarclayCardPayeeInfoOperationRequest request = (MergeBarclayCardPayeeInfoOperationRequest) args[0];
	...
	TransactionAuditDTO transactionAuditDTO = new TransactionAuditDTO();
	MergeBarclayCardPayeeInfoOperationResponse response = (MergeBarclayCardPayeeInfoOperationResponse) result;
	ScreenDataDTO screenData = new ScreenDataDTO();
	if (response != null) {
