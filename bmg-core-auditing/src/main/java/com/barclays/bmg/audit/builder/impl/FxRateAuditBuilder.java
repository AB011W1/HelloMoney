...
public class FxRateAuditBuilder extends AbstractTransactionAuditBuilder {

    /**
     * The Constant named "SCRNNAM_BP" is created.
     */
    private static final String SCRNNAM_BP = "VIEW_FX_RATES";

    @Override
    public TransactionAuditDTO buildFromRequest(Object[] args, Object result) {

	FxRateOperationRequest request = (FxRateOperationRequest) args[0];
	...
	FxRateOperationResponse response = (FxRateOperationResponse) result;
	ScreenDataDTO screenData = new ScreenDataDTO();
