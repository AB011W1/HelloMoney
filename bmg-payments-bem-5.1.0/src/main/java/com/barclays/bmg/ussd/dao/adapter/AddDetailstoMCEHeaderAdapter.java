...
public class AddDetailstoMCEHeaderAdapter extends AbstractReqAdptOperation {
    /**
	...
	return super.buildRequestHeader(workContext, ServiceIdConstants.ADD_DETAILS_TO_MCE_FOR_REGISTRATION);
    }
}
