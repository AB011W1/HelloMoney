...
public class CreditCardUnbilledTransHeaderAdapter extends AbstractReqAdptOperation {

    public static final String SERVICE_RETRIEVE_CREDIT_CARD_UNBILLED_TRANSACTIONS = "RetrieveCreditCardUnbilledTransactions";

    public BEMReqHeader buildCreditCardUnbilledTransHeader(WorkContext workContext) {
