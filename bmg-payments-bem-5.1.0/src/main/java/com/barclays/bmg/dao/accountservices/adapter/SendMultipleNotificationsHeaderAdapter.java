...
public class SendMultipleNotificationsHeaderAdapter extends
	...
	reqHeader.setServiceContext(createServiceContext(context, ServiceIdConstants.SEND_MULTIPLE_NOTIFICATIONS_ONEWAY));
	return reqHeader;
    }
