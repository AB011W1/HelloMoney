...
public class InternationalFundTransferTransmissionService implements TransmissionService{

	private FinancialTransactionProcessing_PortType remoteService;
	@Override
	public Object sendAndReceive(Object object) throws Exception {
		MakeInternationalFundTransferRequest request = (MakeInternationalFundTransferRequest) object;

		MakeInternationalFundTransferResponse response = null;
		try{
			response = remoteService.makeInternationalFundTransfer(request);
