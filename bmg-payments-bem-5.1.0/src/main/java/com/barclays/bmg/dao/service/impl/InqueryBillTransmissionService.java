...
public class InqueryBillTransmissionService implements TransmissionService {

	private FinancialTransactionProcessing_PortType remoteService;
	@Override
	public Object sendAndReceive(Object object) throws Exception {

		UAERetrieveBillDetailsRequest request = (UAERetrieveBillDetailsRequest) object;
		UAERetrieveBillDetailsResponse response = null;
		try{
			response = remoteService.UAERetrieveBillDetails(request);
