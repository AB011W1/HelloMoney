...
public class RetreiveOrgBeneficiaryDtlsHeaderAdapter extends AbstractReqAdptOperation{


	public BEMReqHeader buildRequestHeader(WorkContext workContext){

		return super.buildRequestHeader(workContext, ServiceIdConstants.SERVICE_RETRIEVE_ORGANIZATION_BENEFICIARY_DETAILS);
	}
