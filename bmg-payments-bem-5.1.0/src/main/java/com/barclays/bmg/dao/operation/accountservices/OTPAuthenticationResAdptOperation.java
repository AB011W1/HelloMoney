...
public class OTPAuthenticationResAdptOperation extends AbstractAuthResAdaptOperation {
	...
	if (AuthResponseCodeConstants.AUTH_SUCCESS.equals(resCde)) {
	    ...
	    Context context = authenticationServiceResponse.getContext();
	    if (context != null) {
		context.setUserId(respCustomerInfo.getUserId());
	    }
