...
public class CreateIndividualCustomerTransmissionService  implements TransmissionService {


		private IndividualCustomerManagement_PortType  remoteService;
		@Override
		public Object sendAndReceive(Object object) throws Exception {
			CreateIndividualCustomerRequest request = (CreateIndividualCustomerRequest)object;

			CreateIndividualCustomerResponse response = null;
			try{
				response = remoteService.createIndividualCustomer(request);
