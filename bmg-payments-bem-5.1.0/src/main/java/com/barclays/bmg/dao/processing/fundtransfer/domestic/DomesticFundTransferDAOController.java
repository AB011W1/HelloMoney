package com.barclays.bmg.dao.processing.fundtransfer.domestic;
...
import com.barclays.bmg.dao.operation.fundtransfer.domestic.DomesticFundTransferReqAdptOperation;
import com.barclays.bmg.dao.operation.fundtransfer.domestic.DomesticFundTransferRespAdptOperation;
...
public class DomesticFundTransferDAOController implements Controller {
	...
	DomesticFundTransferServiceResponse domesticFundTransferServiceResponse = (DomesticFundTransferServiceResponse) obj2;

	if (domesticFundTransferServiceResponse.isSuccess()) {
	    MakeDomesticFundTransferRequest fundTransferRequest = (MakeDomesticFundTransferRequest) obj;
	    BEMReqHeader reqHeader = fundTransferRequest.getRequestHeader();

	    domesticFundTransferServiceResponse.setTrnRef(reqHeader.getServiceContext().getConsumerUniqueRefNo());
	    domesticFundTransferServiceResponse.setTrnDate(reqHeader.getServiceContext().getServiceDateTime().getTime());
	}
    ...
    public void setDomesticFundTransferReqAdptOperation(DomesticFundTransferReqAdptOperation domesticFundTransferReqAdptOperation) {
    ...
    public void setDomesticFundTransferRespAdptOperation(DomesticFundTransferRespAdptOperation domesticFundTransferRespAdptOperation) {
