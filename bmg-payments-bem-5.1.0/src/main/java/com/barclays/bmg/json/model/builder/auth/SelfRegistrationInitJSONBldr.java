...
public class SelfRegistrationInitJSONBldr implements BMBJSONBuilder {
	...
	SelfRegistrationInitJSONResponseModel responseModel = null;

	if (response != null) {

	    responseModel = new SelfRegistrationInitJSONResponseModel();
	    responseModel.setServiceResponse(response.getServiceResponse());
	    responseModel.setFullName(response.getContext().getFullName());
	}
	...
	String respId = ResponseIdConstants.SELF_REGISTRATION_INIT_RESPONSE_ID;
