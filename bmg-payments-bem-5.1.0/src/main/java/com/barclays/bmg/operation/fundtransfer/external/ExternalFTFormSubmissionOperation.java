...
public class ExternalFTFormSubmissionOperation extends BMBPaymentsOperation {

	private static final String AED = "AED";
	private static final String KES = "KES";

	public ExternalFTFormSubmissionOperationResponse validateForm(
			ExternalFTFormSubmissionOperationRequest request) {
