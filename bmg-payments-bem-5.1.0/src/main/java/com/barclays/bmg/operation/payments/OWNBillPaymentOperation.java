...
public class OWNBillPaymentOperation extends BMBPaymentsOperation {
    ...
    @AuditSupport(auditType = AuditConstant.AUDIT_TYPE_TRANSACTION, activityState = AuditConstant.SRC_COM_SSC, serviceDescription = "SD_OWN_PAY_BILL", stepId = "3", activityType = "auditOwnBillPayment")
	...
	payBillServiceRequest.setTxnNote(transactionDTO.getTxnNot());
	payBillServiceRequest.setBillPayTxnTyp("CCP");
