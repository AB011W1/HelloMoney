	...
	<body>
		<form>
			...
			<div class="barclaysRibbon">
				<img class="barclaysLogo" src="images/barclays_logo.png">
				...
				<tr>
					<td>
						<div class="filterSideBar">
							...
							<select class="dropDown" id="bsnssId" onChange='updateAgg(this);updateMobNo();updatePort();updateDomain();updateFreeDialUssd(this);'>
                                ...
                                <option value="MZBRB">Mozambique</option>
                                <option value="TZNBC">TZNBC</option>
							</select>
							<br/>
							...
							<input type="text" class="filterInput" maxlength="12" id="msisdn" name="msisdn" onChange="msisdnChange();" value="">
							<br/>
							<label class="fieldLabel">User Input</label>
							<input type="text" class="filterInput" id="tempInputURL" name="tempInputURL">
							<br/><label class="amountFieldLabel" id="topUpAmount" style="visibility:hidden">Amount</label>
					...
					<td>
						<div class="navigationContainer">
							<ul>
								...
								--><li class="logNavigation"><a class="loglink" href="https://zadsdcrapp1195.ocorp.dsarena.com:9447/logview/listlogs.jsp?logfolder=HelloMoney&profile=logView" target="_blank">SIT</a></li>
