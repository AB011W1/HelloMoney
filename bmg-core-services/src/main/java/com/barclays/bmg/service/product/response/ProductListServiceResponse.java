...
public class ProductListServiceResponse extends ResponseContext {
    /**
	 *
	 */
	...
	if (obj == null)
	    return false;
	if (!(obj instanceof ProductListServiceResponse))
	    return false;
	ProductListServiceResponse other = (ProductListServiceResponse) obj;
