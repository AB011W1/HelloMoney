...
/*	private static final String FTCM_EP = "FinancialTransactionCardManagment_EndPoint";
	...
	// Added for HSM DR environment
	public static final String HSM_DR_ENABLE_FLAG_KEY = "HSM.CurrenEnv";
	...
	// Added for HSM DR environment
	public static final boolean HSM_DR_FLAG = DisasterRecoveryHelper.checkHSMDRFlag();
	...
	public static boolean checkHSMDRFlag() {
		LOGGER.info("before fetching HSM.CurrenEnv");
		return DR_ENABLED.equalsIgnoreCase(JVMFetchTool.fetchJVMParm(HSM_DR_ENABLE_FLAG_KEY));
	}
	...
	public static boolean checkMQSOAPLOGLEVEL() {
		...
		return MQ_SOAP_LOG_DB_LEVEL_DEBUG.equalsIgnoreCase(JVMFetchTool.fetchJVMParm(MQ_SOAP_LOG_DB_LEVEL_FLAG))
				|| null != JVMFetchTool.fetchJVMParm(MQ_SOAP_LOG_DB_LEVEL_FLAG);
	}
