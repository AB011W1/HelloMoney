 DELETE FROM C_BANKROUTING_MST WHERE SYSTEM_ID = 'UB' and BUSINESS_ID = 'KEBRB';
 DELETE FROM C_BILLER_MST WHERE SYSTEM_ID = 'UB' and BUSINESS_ID = 'KEBRB';
 DELETE FROM C_BUSINESS_MST WHERE SYSTEM_ID = 'UB' and BUSINESS_ID = 'KEBRB';
 ...
 DELETE FROM C_INTEREST_RATE_MST WHERE SYSTEM_ID = 'UB' and BUSINESS_ID = 'KEBRB';
 ...
 DELETE FROM C_PRODUCT_MST WHERE SYSTEM_ID = 'UB' and BUSINESS_ID = 'KEBRB';
 DELETE FROM S_FUNCTION_CONFIG WHERE SYSTEM_ID = 'UB' and BUSINESS_ID = 'KEBRB';
 DELETE FROM S_LIMIT_CUST_TOTAL WHERE SYSTEM_ID = 'UB' and BUSINESS_ID = 'KEBRB';
