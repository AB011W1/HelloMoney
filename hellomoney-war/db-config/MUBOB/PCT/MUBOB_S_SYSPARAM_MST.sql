...
INSERT INTO S_SYSPARAM_MST (BUSINESS_ID,SYSTEM_ID,PARAM_ID,PARAM_VALUE,PARAM_COMPONENT_KEY,ACTIVITY_ID,SYSTEM_MAINTAIN,DISP_TYPE,MODIFIED_DTM,MODIFIED_BY,AUTHORISED_BY,AUTHORISED_DTM,DELETE_FLG,PARAM_DESC,CREATED_BY,CREATED_DTM) values ('MUBOB','MB','PMT_FT_BKD_SUPPORT_CURRENCY','BWP',null,'PMT_FT_MRC_ONETIME','Y','DROP_DOWN',null,null,null,null,null,'Supported currency for bank draft request',null,to_timestamp('07-MAY-12 14.29.13.000000000','DD-MON-RR HH24.MI.SS.FF'));
