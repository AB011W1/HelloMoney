 ...
 */
public class AddBeneficiaryFormSubmissionJSONBldr extends BMBMultipleResponseJSONBuilder implements BMBJSONBuilder {
	...
	AddBeneficiaryFormSubmissionOperationResponse addBeneficiaryFormSubmissionOperationResponse = (AddBeneficiaryFormSubmissionOperationResponse) responses[0];

	BeneficiaryDTO beneficiaryDTO = addBeneficiaryFormSubmissionOperationResponse.getBeneficiaryDTO();

	AddBeneficiaryJSONModel beneficiaryJSONModel = new AddBeneficiaryJSONModel(beneficiaryDTO);

	Context context = addBeneficiaryFormSubmissionOperationResponse.getContext();
	...
	responseModel.setTxnDate(BMGFormatUtility.getLongDate(DateTimeUtil.getCurrentBusinessCalendar(
		addBeneficiaryFormSubmissionOperationResponse.getContext()).getTime()));
