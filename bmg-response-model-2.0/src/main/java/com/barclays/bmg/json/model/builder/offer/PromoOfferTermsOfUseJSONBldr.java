...
public class PromoOfferTermsOfUseJSONBldr implements BMBJSONBuilder {
	...
	protected BMBPayloadHeader createHeader(TermsOfUseOperationResponse resp) {
		...
		header.setResId(ResponseIdConstants.PROMO_OFFER_TERMSCOND);

		return header;

	}

	protected void populatePayLoad(TermsOfUseOperationResponse response,
