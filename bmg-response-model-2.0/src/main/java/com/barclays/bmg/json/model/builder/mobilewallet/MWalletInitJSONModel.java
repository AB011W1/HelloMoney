 ...
 * </br>
 * The file name is  <b>MWalletInitJSONModel.java</b>
 * </br>
 ...
 * @author e20037686
 * </br>
 * * The Class MWalletInitJSONModel created using JRE 1.6.0_10
 */
public class MWalletInitJSONModel extends BMBPayloadData {


	private static final long serialVersionUID = 6823435758426450100L;
	 ...
	 */
	private List<BillerDTO> billerDTO = new ArrayList<BillerDTO>();
	 ...
	 */
	public List<BillerDTO> getBillerDTO() {
		return billerDTO;
	}
	 ...
	 *
	 * @param billerDTO the biller dto
	 */
	public void setBillerDTO(List<BillerDTO> billerDTO) {
