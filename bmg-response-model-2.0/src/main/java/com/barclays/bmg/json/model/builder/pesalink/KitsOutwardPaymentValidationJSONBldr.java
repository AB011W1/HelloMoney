 ...
 */
public class KitsOutwardPaymentValidationJSONBldr extends BMBCommonJSONBuilder implements BMBJSONBuilder{


	    @Override
	    public Object createJSONResponse(ResponseContext responseContext) {

	    	if (responseContext instanceof MakeBillPaymentOperationResponse) {
	    		MakeBillPaymentOperationResponse response = (MakeBillPaymentOperationResponse) responseContext;
	     ...
	     */
	    protected BMBPayloadHeader createHeader(MakeBillPaymentOperationResponse response) {
...
//	    	if (response != null && response.isSuccess()) {
//	    		responseModel = new SearchIndividualCustforDeDupCheckJsonModel(response);
//	    		if(response.getIndividualCustomerBasicOpResList()!=null && response.getIndividualCustomerBasicOpResList().size()!=0){
//
//	    			List
//	    			responseModel.setIndividualCustomerBasicModelList(response.getIndividualCustomerBasicOpResList());
//	    		}
//	    	}
