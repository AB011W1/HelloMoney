...
public class InternationalFundTransferPayInfoJSONBldr extends ExternalFundTransferPayInfoJSONBldr {
	...
	protected BMBPayloadHeader createHeader(ResponseContext response) {
		...
		header.setResId(ResponseIdConstants.INTERNATIONAL_FUND_TRANSFER_PAY_INFO);
