 ...
 * </br>
 * The file name is  <b>MwalletUpInitJSONBldr.java</b>
 * </br>
 ...
 * @author e20037686
 * </br>
 * * The Class MwalletUpInitJSONBldr created using JRE 1.6.0_10
 */
public class MwalletUpInitJSONBldr extends BMBMultipleResponseJSONBuilder {
	...
	protected BMBPayloadHeader createHeader(ResponseContext response) {
		...
		header.setResId(ResponseIdConstants.M_WALLET_INIT);
		return header;
	...
	protected void populatePayLoad(BMBPayload bmbPayload,
		...
		MWalletInitJSONModel responseModel = new MWalletInitJSONModel();

		RetrieveAcctListOperationResponse acctListOperationResponse = (RetrieveAcctListOperationResponse) responses[0];

		MWalletOperationResponse mWalletOperationResponse = (MWalletOperationResponse) responses[1];

		List<BillerDTO> billerList = mWalletOperationResponse.getBillerList();
		...
		//responseModel.setBillerDTO(billerList);
