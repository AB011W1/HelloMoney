...
import com.barclays.bmg.json.model.ApplyProductConfirmationJsonModel;
...
public class ApplyProductConfirmJsonBldr extends BMBCommonJSONBuilder implements BMBJSONBuilder {

    @Override
    public Object createJSONResponse(ResponseContext responseContext) {

    	if (responseContext instanceof ApplyProductConfirmOperationResponse) {
    		ApplyProductConfirmOperationResponse response = (ApplyProductConfirmOperationResponse) responseContext;
     ...
     */
    protected BMBPayloadHeader createHeader(ApplyProductConfirmOperationResponse response) {
     ...
     * @return void
     */
    protected void populatePayLoad(ApplyProductConfirmOperationResponse response, BMBPayload bmbPayload) {
    	ApplyProductConfirmationJsonModel responseModel = null;
    	if (response != null && response.isSuccess()) {
    		responseModel = new ApplyProductConfirmationJsonModel();
