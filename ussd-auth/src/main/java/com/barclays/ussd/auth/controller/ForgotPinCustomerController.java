 ...
 */
@Controller
public class ForgotPinCustomerController extends USSDAbstractController {

    private static final String TRUE = "true";

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(ForgotPinCustomerController.class);
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/forgotpinpage", method = { RequestMethod.POST })
	...
	try {
	    ...
	    ussdSessionMgmt.setScreenId("200");
	    ussdSessionMgmt.setCurrentScreenNodeId("ussd3.00");
