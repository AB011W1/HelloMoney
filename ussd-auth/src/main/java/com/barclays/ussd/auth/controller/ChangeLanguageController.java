 ...
 */
@Controller
public class ChangeLanguageController extends USSDAbstractController implements ServletContextAware {
    private ServletContext ussdContext;
    private static final String EMPTY_STRING = "";

    private static final String CHANGE_LANGUAGE_SERVICE = "ChangeLanguage";
	...
	try {
	    ...
	    ussdSessionMgmt.setChangeLanguageMode(TRUE);
	    ...
	    MenuItemDTO menuItemDTO = ussdByPassXMLMenuManager.handleChangeLanguageRequest(paramDTO, ussdSessionMgmt, errorCodes);
	    ...
	    if (StringUtils.equalsIgnoreCase(USSDExceptions.USSD_CHANGE_LANGUAGE.getBmgCode(), ube.getErrCode())) {
		ussdSessionMgmt.setChangeLanguageMode(FALSE);
		RequestDispatcher requestDispatcher = ussdContext.getRequestDispatcher(FORWARD_TO_UNREGISTERED_USER_MENU);
	...
	paramDTO.setServiceName(CHANGE_LANGUAGE_SERVICE);
