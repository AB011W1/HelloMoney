...
public abstract class ObjectsUtility {
	...
	primitivesAndWrappers.add(Short.class);
	primitivesAndWrappers.add(BigDecimal.class);
	primitivesAndWrappers.add(Date.class);
    }
     ...
     * </p>
     * <p>
     * This method will return an empty <code>StringBuffer</code> if the given object is <code>null</code>.
     * </p>
     * 
     * @param obj
     *            the given object.
     ...
     * @param clazz
     *            the given class.
     * @return <code>true</code> if the given class represents a primitive or a wrapper, <code>false</code> otherwise.
     */
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two <code>boolean</code> arrays <code>a</code> and <code>b</code>
     * such that <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two <code>byte</code> arrays <code>a</code> and <code>b</code> such
     * that <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * 
     * <p>
     * If <code>array</code> is <code>null</code>, this method returns 0.
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two <code>char</code> arrays <code>a</code> and <code>b</code> such
     * that <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two <code>double</code> arrays <code>a</code> and <code>b</code> such
     * that <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two <code>float</code> arrays <code>a</code> and <code>b</code> such
     * that <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two <code>int</code> arrays <code>a</code> and <code>b</code> such
     * that <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two <code>long</code> arrays <code>a</code> and <code>b</code> such
     * that <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Returns the value of <code>{@link Object#hashCode()}</code>. If the object is an array, this method will delegate to any of the
	...
	if (obj instanceof String) {
	    return nullSafeHashCode((String) obj);
	}
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two arrays <code>a</code> and <code>b</code> such that
     * <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * <p>
     * The value returned by this method is equal to the value that would be returned by <code>Arrays.asList(a).hashCode()</code>, unless
     * <code>array</code> is <code>null</code>, in which case <code>0</code> is returned.
     * </p>
     * 
     * @param array
    ...
    /**
     * <p>
     * Returns a hash code based on the contents of the specified array. For any two <code>short</code> arrays <code>a</code> and <code>b</code> such
     * that <code>Arrays.equals(a, b)</code>, it is also the case that <code>Arrays.hashCode(a) == Arrays.hashCode(b)</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * Returns a string representation of the contents of the specified array. The string representation consists of a list of the array's elements,
     * enclosed in curly braces (<code>"{}"</code>). Adjacent elements are separated by the characters <code>", "</code> (a comma followed by a
     * space). Returns <code>"null"</code> if <code>array</code> is <code>null</code>.
     * 
     * @param array
