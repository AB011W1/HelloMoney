...
public class GhipsRegisterBenefAddRequestBuilder implements BmgBaseRequestBuilder {
	...
	public USSDBaseRequest getRequestObject(
		...
		List<String> txnRefNoLst = (List<String>) requestBuilderParamsDTO.getUssdSessionMgmt().getTxSessions().get(
    			USSDInputParamsEnum.GHIPS_REGISTER_BENEF_BANK_CONFIRM.getTranId());
   		requestParamMap.put(USSDInputParamsEnum.GHIPS_REGISTER_BENEF_BANK_ADD.getParamName(), txnRefNoLst.get(0));
