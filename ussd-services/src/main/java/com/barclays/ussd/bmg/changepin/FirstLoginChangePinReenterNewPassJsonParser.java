...
public class FirstLoginChangePinReenterNewPassJsonParser implements BmgBaseJsonParser, SystemPreferenceValidator {
    private static final Logger LOGGER = Logger.getLogger(FirstLoginChangePinReenterNewPassJsonParser.class);
	...
	USSDCompositeValidator validator = new USSDCompositeValidator(new USSDChangePasswordValidator(userInputMap
		.get(USSDInputParamsEnum.FIRST_LOGIN_CHNG_PIN_NEW_PASS.getParamName()), userInput));
	try {
