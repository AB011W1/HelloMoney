...
public class GhipsOneOffBenefConfirmRequestBuilder implements BmgBaseRequestBuilder {
	...
	throws USSDNonBlockingException, USSDBlockingException {
		...
		.get(USSDInputParamsEnum.GHIPS_BANK_ACC_NO
				.getParamName());
		String userEnteredBenefName = userInputMap
		.get(USSDInputParamsEnum.GHIPS_FUND_TRANSFER_NICK_NAME
				.getParamName());
		...
		if (userEnteredAccountNum != null
			...
			requestParamMap.put(USSDInputParamsEnum.GHIPS_BANK_ACC_NO
			...
			requestParamMap.put(USSDInputParamsEnum.GHIPS_BANK_LIST.getParamName(), userEnteredBankCode);
			requestParamMap.put("bankName", bankName);
			requestParamMap.put(USSDInputParamsEnum.GHIPS_FUND_TRANSFER_NICK_NAME
