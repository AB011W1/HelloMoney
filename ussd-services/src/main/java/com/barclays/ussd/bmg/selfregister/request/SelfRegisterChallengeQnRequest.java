...
public class SelfRegisterChallengeQnRequest implements BmgBaseRequestBuilder {
    @Autowired
	...
	if (selfRegQuestList != null && !selfRegQuestList.isEmpty()) {
	    ...
	    requestParamMap.put(USSDInputParamsEnum.SELFREG_GET_QUESTION.getParamName(), selfRegQuesions.toString());
