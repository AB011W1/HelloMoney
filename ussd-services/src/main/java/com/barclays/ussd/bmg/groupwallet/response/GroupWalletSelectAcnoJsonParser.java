...
public class GroupWalletSelectAcnoJsonParser implements BmgBaseJsonParser {
	private static final String TRANSACTION_FROM_ACCOUNT_LABEL = "label.groupwallet.select.accnum";
	...
	public void setNextScreenSequenceNumber(MenuItemDTO menuItemDTO) {
		// TODO Auto-generated method stub
		menuItemDTO.setNextScreenSequenceNumber(USSDSequenceNumberEnum.SEQUENCE_NUMBER_TWENTYNINE.getSequenceNo());
	}
