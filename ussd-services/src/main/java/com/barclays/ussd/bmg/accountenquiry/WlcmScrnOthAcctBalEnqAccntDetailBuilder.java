 ...
 * 
 */
public class WlcmScrnOthAcctBalEnqAccntDetailBuilder implements BmgBaseRequestBuilder {
	...
	String userInput = userInputMap.get(USSDInputParamsEnum.WLCME_BAL_ENQ_SEL_AC.getParamName());
	List<CustomerMobileRegAcct> lstAccntDet = (List<CustomerMobileRegAcct>) ussdSessionMgmt.getTxSessions().get(
		USSDInputParamsEnum.WLCME_BAL_ENQ_SEL_AC.getTranId());
