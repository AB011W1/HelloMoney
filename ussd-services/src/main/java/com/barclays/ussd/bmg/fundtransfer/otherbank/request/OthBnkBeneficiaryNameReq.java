...
public class OthBnkBeneficiaryNameReq implements BmgBaseRequestBuilder {
	...
	public USSDBaseRequest getRequestObject(
		...
		requestParamMap.put(USSDInputParamsEnum.EDIT_BENF_EXT_SERVICE_NAME
				.getParamName(), EDIT_BENF);
