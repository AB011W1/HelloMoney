...
public class FreeDialSubmitRequestBuilder implements BmgBaseRequestBuilder {
	...
	List<String> txnRefNoLst = (List<String>) requestBuilderParamsDTO.getUssdSessionMgmt().getTxSessions().get(
		USSDInputParamsEnum.FREE_DIAL_CONFIRM.getTranId());

	requestParamMap.put(USSDInputParamsEnum.FREE_DIAL_SUBMIT.getParamName(), txnRefNoLst.get(0));
