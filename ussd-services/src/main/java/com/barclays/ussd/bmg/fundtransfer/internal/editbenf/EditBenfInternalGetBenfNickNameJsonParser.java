...
public class EditBenfInternalGetBenfNickNameJsonParser implements BmgBaseJsonParser, SystemPreferenceValidator {
    @Autowired
    private ListValueResServiceImpl listValueResService;

    private static final Logger LOGGER = Logger.getLogger(EditBenfInternalGetBenfNickNameJsonParser.class);
