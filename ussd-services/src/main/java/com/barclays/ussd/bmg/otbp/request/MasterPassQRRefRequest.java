 ...
 *
 */
public class MasterPassQRRefRequest implements BmgBaseRequestBuilder {
	...
	public USSDBaseRequest getRequestObject(
		...
		dto.setParameterId("masterpassQREnabled");
		dto.setSystemId("UB");
		...
		if (null == response || (null != response && null != response.getSystemParameterDTO()
		    ...
		    throw new USSDNonBlockingException(USSDExceptions.USSD_MASTERPASS_SERVICE_DISABLED.getBmgCode());
		}
