...
public class CreditCardPaymentDetailsRequestBuilder implements BmgBaseRequestBuilder {
	...
	if (lstAccntDet != null && !lstAccntDet.isEmpty() && StringUtils.isNotBlank(userSelection)) {
	    ...
	    userInputMap.put(USSDInputParamsEnum.CR_CARD_PAYMENT_ACCT_NO.getParamName(), acntDet.getActNo());
