...
public class GroupWalletOptionsListJsonParser implements BmgBaseJsonParser,ScreenSequenceCustomizer {
	...
	public int getCustomNextScreen(String userInput,
		...
		// TODO Auto-generated method stub
		int seqNo = USSDSequenceNumberEnum.SEQUENCE_NUMBER_TWENTYSIX.getSequenceNo();

		if (userInput.equals("2")) {
			seqNo = USSDSequenceNumberEnum.SEQUENCE_NUMBER_THIRTYONE.getSequenceNo();
		}
		if (userInput.equals("3")) {
			seqNo = USSDSequenceNumberEnum.SEQUENCE_NUMBER_THIRTYFIVE.getSequenceNo();
		}
		return seqNo;
	}
