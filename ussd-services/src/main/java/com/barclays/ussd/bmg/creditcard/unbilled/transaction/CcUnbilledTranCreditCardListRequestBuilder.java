...
public class CcUnbilledTranCreditCardListRequestBuilder implements BmgBaseRequestBuilder {
	...
	requestParamMap.put(USSDInputParamsEnum.ACTIVITY_ID.getParamName(), "ACT_CCD_UNBILLED_TRANS");
