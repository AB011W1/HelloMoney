...
public class RegisterBenfExtConfirmJsonParser implements BmgBaseJsonParser {

    private static final String RESULT_MESSAGE = "label.benef.reg.successfull";
    private static final Logger LOGGER = Logger.getLogger(RegisterBenfExtConfirmJsonParser.class);
