...
public class KitsSendToPhoneSubmitRequestBuilder implements BmgBaseRequestBuilder {
    ...
    public USSDBaseRequest getRequestObject(RequestBuilderParamsDTO requestBuilderParamsDTO) throws USSDNonBlockingException, USSDBlockingException {
		...
		requestParamMap.put("receipientMobileNo", userInputMap.get(USSDInputParamsEnum.KITS_STP_MOBILE_NUM.getParamName()));
		...
		//amount entered
		requestParamMap.put("txnAmount", userInputMap.get(USSDInputParamsEnum.KITS_STP_AMOUNT.getParamName()));
		//reason entered
		requestParamMap.put("txnReason", userInputMap.get(USSDInputParamsEnum.KITS_STP_REASON.getParamName()));
		//debitAccount
		 List<AccountDetails> accList= (List<AccountDetails>) txSessions.get(USSDInputParamsEnum.KITS_STP_ACCOUNT_NUM.getTranId());
        ...
        //Activity Id
		requestParamMap.put("activityId", "KITS_PTP_BILLPAY");
