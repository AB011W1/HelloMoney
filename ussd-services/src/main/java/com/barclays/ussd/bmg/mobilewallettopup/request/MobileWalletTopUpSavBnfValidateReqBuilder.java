...
public class MobileWalletTopUpSavBnfValidateReqBuilder implements BmgBaseRequestBuilder {
    private static final String PAY_GRP = "payGrp";

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(MobileWalletTopUpSavBnfValidateReqBuilder.class);
    @Autowired
	...
	if(billerUsrInput==null){
		billerUsrInput=userInputMap.get(USSDInputParamsEnum.MOBILE_WALLET_MNOS_LST.getParamName());
	}
