...
public class GroupWalletGetAmountJsonParser implements BmgBaseJsonParser,SystemPreferenceValidator {
	@Autowired
	...
	private static String LABEL_ENTER_AMOUNT="label.gw.enter.amount";
	@Override
	...
	throws USSDBlockingException, USSDNonBlockingException {
		...
		String mwalleteAmountLabel = responseBuilderParamsDTO.getUssdResourceBundle().getLabel(LABEL_ENTER_AMOUNT, paramArray,
