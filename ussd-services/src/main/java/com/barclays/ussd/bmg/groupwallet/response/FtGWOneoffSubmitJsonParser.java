...
public class FtGWOneoffSubmitJsonParser implements BmgBaseJsonParser {
	private static final Logger LOGGER = Logger.getLogger(FtGWOneoffSubmitJsonParser.class);
