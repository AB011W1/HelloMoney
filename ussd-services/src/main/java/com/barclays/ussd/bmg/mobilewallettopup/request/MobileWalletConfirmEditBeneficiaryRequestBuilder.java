...
public class MobileWalletConfirmEditBeneficiaryRequestBuilder  implements BmgBaseRequestBuilder {
	...
	public USSDBaseRequest getRequestObject(RequestBuilderParamsDTO requestBuilderParamsDTO) {
		...
		if(mnoList!=null && mnoList.size() != 0){
			billerId = mnoList.get(Integer.parseInt(userInputMap.get(USSDInputParamsEnum.MOBILE_WALLET_NEW_BENE_SRC_MON.getParamName())) - 1).getBillerId();
