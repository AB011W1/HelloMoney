 ...
 * 
 */
public class CreditCardPaymentSubmitJsonParser implements BmgBaseJsonParser {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(CreditCardPaymentSubmitJsonParser.class);
	...
	if (billPayConfirmData != null) {
	    ...
	    String txIdLabel = ussdResourceBundle.getLabel(USSDConstants.CREDIT_CARD_PAYMENT_SUCCESS, new Locale(ussdSessionMgmt.getUserProfile()
		    .getLanguage(), ussdSessionMgmt.getUserProfile().getCountryCode()));
