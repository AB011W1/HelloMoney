...
public class GhipsOneOffBnkListJsonParser implements BmgBaseJsonParser {
	/** The Constant LOGGER. */
	...
	private MenuItemDTO renderMenuOnScreen(
		...
		responseBuilderParamsDTO.getUssdSessionMgmt().getTxSessions().put(USSDInputParamsEnum.GHIPS_BANK_LIST.getTranId(),bankList);
