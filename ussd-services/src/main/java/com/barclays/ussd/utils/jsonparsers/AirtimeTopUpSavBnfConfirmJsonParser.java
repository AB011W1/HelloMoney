...
public class AirtimeTopUpSavBnfConfirmJsonParser implements BmgBaseJsonParser {

    private static final String AIRTIME_SAVE_BNF_SUCCESS_LABEL = "label.airtime.savebenf.success";
    private static final Logger LOGGER = Logger.getLogger(AirtimeTopUpSavBnfConfirmJsonParser.class);
