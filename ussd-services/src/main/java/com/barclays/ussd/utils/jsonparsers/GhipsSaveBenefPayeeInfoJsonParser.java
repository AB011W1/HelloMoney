...
public class GhipsSaveBenefPayeeInfoJsonParser implements BmgBaseJsonParser {

	   private static final Logger LOGGER = Logger.getLogger(GhipsSaveBenefPayeeInfoJsonParser.class);
		...
		if (payeeInfoData != null) {
		    ...
		    txSessions.put(USSDInputParamsEnum.GHIPS_OTHER_BANK_FT_PAYEE_INFO.getTranId(), payeeInfoData.getTxnLmt().getCurr());
		}
	    }
