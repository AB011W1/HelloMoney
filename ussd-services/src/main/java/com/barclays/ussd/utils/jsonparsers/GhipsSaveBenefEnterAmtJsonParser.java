...
public class GhipsSaveBenefEnterAmtJsonParser implements BmgBaseJsonParser,SystemPreferenceValidator {

	@Autowired
	private ListValueResServiceImpl listValueResService;
	private static final String BEM_ERRCODE_7502 = "BEM7502";
	private static final Logger LOGGER = Logger.getLogger(GhipsSaveBenefEnterAmtJsonParser.class);
	...
	public MenuItemDTO parseJsonIntoJava(
		...
		if(customerName!=null && !customerName.equals("")){
			menuDTO.setPageHeader("label.ghips.ft.enter.amount");
			...
			menuDTO.setStatus(USSDConstants.STATUS_CONTINUE);
