 ...
 * 
 */
public class DelBillrValParser implements BmgBaseJsonParser {
    ...
    private static final Logger LOGGER = Logger.getLogger(DelBillrValParser.class);
