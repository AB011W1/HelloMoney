...
public class DelBillrCnfParser implements BmgBaseJsonParser {
    private static final Logger LOGGER = Logger.getLogger(DelBillrCnfParser.class);
    private static final String BILLER_DELTED_SUCCESS = "label.biller.deleted.success";
