...
public class NBADBConfirmJsonParser implements BmgBaseJsonParser {
    /**
     * label.benefdeleted.success
     */
    private static final String DELETIONSUCCESS_LABEL = "label.benefdeleted.success";

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(NBADBConfirmJsonParser.class);
	...
	if (delBenefConfirm != null) {
	    ...
	    String successMessage = responseBuilderParamsDTO.getUssdResourceBundle().getLabel(DELETIONSUCCESS_LABEL,
