...
public class AirtimeTopupDelBillrCnfParser implements BmgBaseJsonParser {
    private static final Logger LOGGER = Logger.getLogger(AirtimeTopupDelBillrCnfParser.class);
