...
public class GhipsSaveBenefConfirmJsonParser implements BmgBaseJsonParser {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(GhipsSaveBenefConfirmJsonParser.class);
	...
	if (formValResData != null) {
	    responseBuilderParamsDTO.getUssdSessionMgmt().getTxSessions()
		    .put(USSDInputParamsEnum.GHIPS_OTHER_BANK_FT_SUBMIT.getTranId(), formValResData.getTxnRefNo());
	}
    }
