...
public class OBADBConfirmJsonParser implements BmgBaseJsonParser {
    private static final String DELTEDSUCCESS_LABEL = "label.benefdeleted.success";

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(OBADBConfirmJsonParser.class);
	...
	if (delBenefConfirm != null) {
	    ...
	    String successMessage = responseBuilderParamsDTO.getUssdResourceBundle().getLabel(DELTEDSUCCESS_LABEL,
