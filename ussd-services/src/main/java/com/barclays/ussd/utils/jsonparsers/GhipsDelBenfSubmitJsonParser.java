...
public class GhipsDelBenfSubmitJsonParser implements BmgBaseJsonParser {
    private static final String DELETIONSUCCESS_LABEL = "label.ghips.delben.success";

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(GhipsDelBenfSubmitJsonParser.class);
