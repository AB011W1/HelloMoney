...
/**
 * @author BTCI ScreenSequenceCustomizer implementation ADDED TO INCLUDE DEBIT CARD VALIDATION IN SELF REGISTRATION
 */
public class SelfRegisterChallengeAnsParser implements BmgBaseJsonParser,ScreenSequenceCustomizer {
    private static final int NO_OF_ATTEMPTS = 0;
    private static final Logger LOGGER = Logger.getLogger(SelfRegisterChallengeAnsParser.class);
	...
	// ADDED TO INCLUDE DEBIT CARD VALIDATION IN SELF REGISTRATION Sequence changed from EIGHT To ELEVEN
