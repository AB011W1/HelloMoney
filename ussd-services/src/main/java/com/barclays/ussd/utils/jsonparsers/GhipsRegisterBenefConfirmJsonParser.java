...
public class GhipsRegisterBenefConfirmJsonParser implements BmgBaseJsonParser {
	...
	private static final String LABEL_CONFIRM_HEADER_MESSAGE = "label.ghips.confirm.header.message";

	private static final Logger LOGGER = Logger
			.getLogger(GhipsRegisterBenefConfirmJsonParser.class);
			...
			if (regBenfInt != null) {
				if (regBenfInt.getPayHdr() != null
					...
					responseBuilderParamsDTO
							...
							.getTxSessions()
							.put(
									USSDInputParamsEnum.GHIPS_REGISTER_BENEF_BANK_CONFIRM
											.getTranId(), txnRefNo);
	...
	public void setNextScreenSequenceNumber(MenuItemDTO menuItemDTO) {
		...
		menuItemDTO
				.setNextScreenSequenceNumber(USSDSequenceNumberEnum.SEQUENCE_NUMBER_SEVEN
						.getSequenceNo());
	}
