 ...
 *
 */
public class EBFTPayeeInfoJsonParser implements BmgBaseJsonParser {
	...
	if (payeeInfoData != null) {
	    ...
	    txSessions.put(USSDInputParamsEnum.EXT_BANK_FT_PAYEE_INFO.getTranId(), payeeInfoData.getTxnLmt().getCurr());
	}
    }
