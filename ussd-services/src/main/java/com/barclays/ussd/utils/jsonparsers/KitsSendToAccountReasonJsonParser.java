...
public class KitsSendToAccountReasonJsonParser implements BmgBaseJsonParser,SystemPreferenceValidator{

	@Autowired
    private ListValueResServiceImpl listValueResService;

    private static final Logger LOGGER = Logger.getLogger(KitsSendToAccountReasonJsonParser.class);
