...
public class GhipsSaveBenefSubmitJsonParser implements BmgBaseJsonParser {

	/** The Constant LOGGER. */
	private static final Logger LOGGER = Logger.getLogger(GhipsSaveBenefSubmitJsonParser.class);
