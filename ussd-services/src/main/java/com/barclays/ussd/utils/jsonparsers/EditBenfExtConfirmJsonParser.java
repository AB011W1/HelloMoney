...
public class EditBenfExtConfirmJsonParser implements BmgBaseJsonParser {

	  private static final String RESULT_MESSAGE = "label.benef.edit.successfull";
	    private static final Logger LOGGER = Logger.getLogger(EditBenfExtConfirmJsonParser.class);
