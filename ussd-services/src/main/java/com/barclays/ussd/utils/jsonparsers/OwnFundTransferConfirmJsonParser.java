...
public class OwnFundTransferConfirmJsonParser implements BmgBaseJsonParser {
    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(OwnFundTransferConfirmJsonParser.class);
	...
	if (ownFundTxConfirmPayData != null) {
	    ...
	    pageBody.append(ownFundTxConfirmPayData.getRefNo());
