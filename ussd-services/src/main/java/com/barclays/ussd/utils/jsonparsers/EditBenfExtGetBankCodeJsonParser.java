...
public class EditBenfExtGetBankCodeJsonParser implements BmgBaseJsonParser,ScreenSequenceCustomizer {
	 @Autowired
	...
	public void setNextScreenSequenceNumber(MenuItemDTO menuItemDTO) {
	 ...
	 public int getCustomNextScreen(String userInput, USSDSessionManagement ussdSessionMgmt) throws USSDBlockingException {
			...
			txSessions.put(USSDInputParamsEnum.EDIT_BENF_BRANCH_SEARCHER.getTranId(), bankList);
			// }

			if (bankList != null && bankList.size() == 1) {
			    userInputMap = userInputMap == null ? new HashMap<String, String>() : userInputMap;
			    userInputMap.put(USSDInputParamsEnum.EDIT_BENF_BRANCH_SEARCHER.getParamName(), USSDConstants.DEFAULT_OPTION_SELECTION);
