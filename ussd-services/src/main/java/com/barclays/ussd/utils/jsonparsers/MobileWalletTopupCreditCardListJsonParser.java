 ...
 *
 */
public class MobileWalletTopupCreditCardListJsonParser implements BmgBaseJsonParser {
    	...
    	if(acntPayData!= null)
    	{
		 if (acntPayData.getCustActs() != null && !acntPayData.getCustActs().isEmpty()) {
			 menuItemDTO = new MenuItemDTO();
				...
				txSessions.put(USSDInputParamsEnum.MOBILE_WALLET_CREDIT_CARD_LIST.getTranId(), acntPayData.getCustActs());
				txSessions.put(USSDConstants.CREDIT_MOBILE_WALLET, USSDConstants.CREDIT_MOBILE_WALLET);
				...
				String paramArray[]={ussdSessionMgmt.getUserTransactionDetails().getUserInputMap().get("txnAmt"),currency};
