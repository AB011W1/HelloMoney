...
public class MobileWalletTopUpBeneMngmtJsonParser implements BmgBaseJsonParser,
ScreenSequenceCustomizer {
	...
	private MenuItemDTO renderMenuOnScreen(
		...
		txSessions.put(USSDInputParamsEnum.MOBILE_WALLET_BENE_MANAGEMENT.getTranId(), optionList);
