...
import com.barclays.ussd.bmg.airtime.request.AirtimeTopUpSavBnfValidateReqBuilder;
...
public class AirtimeTopUpSavBnfNickNameJsonParser implements BmgBaseJsonParser {
	@Autowired
	...
	try {
		String payNickNameMaxLength = getSystemPreferenceData(userProfile, SystemPreferenceConstants.SYS_PARAM_BNF,
		 ...
		 List<String> params = new ArrayList<String>(1);
			...
			String successMessage = ussdResourceBundle.getLabel(AIRTIME_SAVE_BNF_NICK_NAME, locale);*/
