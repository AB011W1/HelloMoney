 ...
 * 
 */
public class RegisterBenfInternalBranchCodeJsonParser implements BmgBaseJsonParser, ScreenSequenceCustomizer {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger.getLogger(RegisterBenfInternalBranchCodeJsonParser.class);

    public MenuItemDTO parseJsonIntoJava(ResponseBuilderParamsDTO responseBuilderParamsDTO) throws USSDNonBlockingException {
	List<UssdBranchLookUpDTO> branchList = null;
	MenuItemDTO menuDTO = null;
	try {
	    branchList = (List<UssdBranchLookUpDTO>) responseBuilderParamsDTO.getUssdSessionMgmt().getTxSessions()
		    .get(USSDInputParamsEnum.REG_BEN_INT_BRANCH_CODE.getTranId());
    ...
    public int getCustomNextScreen(String userInput, USSDSessionManagement ussdSessionMgmt) throws USSDBlockingException {
        ...
        if(ussdSessionMgmt.getBusinessId().equalsIgnoreCase("TZBRB"))
        {
